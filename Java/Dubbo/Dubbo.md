...
![](2021-02-03-20-28-21.png)
##<span id=3.1>dubbo架构</span>
![](2021-02-03-20-30-51.png)
...
####Random LoadBalance
![](2021-02-05-21-44-18.png)
随机，按权重设置随机概率。 在一个截面上碰撞的概率高，但调用量越大分布越均匀，而且按概率使用权重后也比较均匀，有利于动态调整提供者权重。
####RoundRobin LoadBalance
![](2021-02-05-21-44-56.png)
轮循，按公约后的权重设置轮循比率。
存在慢的提供者累积请求的问题，比如：第二台机器很慢，但没挂，当请求调到第二台时就卡在那，久而久之，所有请求都卡在调到第二台上。
####LeastActive LoadBalance
![](2021-02-05-21-45-06.png)
最少活跃调用数，相同活跃数的随机，活跃数指调用前后计数差。
使慢的提供者收到更少请求，因为越慢的提供者的调用前后计数差会越大。
####ConsistentHash LoadBalance
![](2021-02-05-21-45-16.png)
...
###BIO：(Blocking IO)
![](2021-02-06-18-27-30.png)

###NIO: (Non-Blocking IO)
![](2021-02-06-18-27-39.png)
...
![](2021-02-06-19-04-47.png)

###dubbo服务暴露流程
具体看源码
![](2021-02-06-19-21-59.png)
###dubbo服务引用流程
![](2021-02-06-19-22-06.png)

###dubbo服务调用流程
![](2021-02-06-19-22-16.png)